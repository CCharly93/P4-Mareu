...
# Projet Maréu
## Présentation 
Le projet __Maréu__ est une application Android qui permet de gérer les réunions pour le personnel de l'entreprise __Lamzone__.
...
- Pour exécuter les tests unitaires : Menu Run->Run… (Alt+Maj+F10)  
- Pour exécuter les tests instrumentalisés : Menu Run->Run… (Alt+Maj+F10) 
